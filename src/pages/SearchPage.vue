...
<template>
  <div id="wrapper-search-page">
    <!-- Search -->
    <div class="container-fluid wrapper">
      <div class="container">
        <section class="row text-center">
          <div
            class="col-12 col-lg-8 col-xl-6 text-center d-flex flex-wrap align-items-center mb-5 mb-lg-0 position-relative"
          >
            <!-- Form Research -->
            <div class="w-100 position-absolute top-0 start-0 end-0">
              <input
          ...
          <div class="col-12 col-lg-4 col-xl-6 text-end mt-5 mt-lg-2">
            <button
              type="button"
